...
description: Extract graded items, readings, office hours, and professor contacts from a syllabus PDF or pasted text. Show a confirmation table before any calendar write.
user-invocable: true
...
1. Extract every graded item: assignments, quizzes, midterms, finals, projects — with exact due dates/times.
