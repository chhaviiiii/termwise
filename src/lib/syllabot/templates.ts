...
or skip rows before anything is written. Always keep weekly office
hours from the syllabus. Do not invent grades or due dates.
...
4. Always expand listed office hours into weekly events across the
   term. Keep them. Do not skip them.
5. Color-code events by course. Sum listed weights and say if the
   syllabus left some percent off the calendar.
6. Offer optional work-back study blocks from listed hours. Keep
   them off until I opt in. Do not invent due dates.
7. Show an editable summary table. Let me fix or skip rows except
   weekly office hours.
8. Wait for confirmation, then put kept items on my chosen calendar
