      ...
      <aside className="flex h-full w-full max-w-md flex-col border-l border-[var(--sb-line)] bg-[var(--sb-card)] text-[var(--sb-ink)] shadow-2xl">
        ...
        <div className="flex-1 space-y-8 overflow-y-auto px-5 py-6">
          ...
          <section>
            ...
            <p className="mt-1 text-xs text-[var(--sb-muted)]">Pick Google Calendar / Gmail, Outlook Calendar / Outlook mail, or Fallback: .ics download / mailto draft. Nothing is forced — no OAuth, nothing sent until you click.</p>
            <div className="mt-3">
              <DestinationChoice
